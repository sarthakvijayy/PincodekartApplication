  ...
  return (
    <View style={styles.sectionWrapper}>
      <LinearGradient colors={['#F3DCAF', '#FFB320']} style={styles.gradientBackground}>
        {/* Top Banner */}
        <Image source={require('../../assets/Sports/sportsBanner.png')} style={styles.bannerImage} />
...
const deals = [
  { title: 'Women Fashion', discount: 'Min 30% OFF', image: require('../../assets/Sports/s1.png') },
  { title: 'Books & Media', discount: 'Min 50% OFF', image: require('../../assets/Sports/s2.png')},
];
